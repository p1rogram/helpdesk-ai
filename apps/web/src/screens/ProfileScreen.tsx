    ...
    <div className="profile">
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ color: 'var(--muted)', fontSize: 13 }}>
              {props.scope === 'guest' ? 'Гость' : (PLATFORM_LABEL[props.platform.kind] ?? props.platform.kind)}
      ...
      <div className="panel">
        ...
        <div className="seg">
          ...
          <button className={props.theme === 'auto' ? 'active' : ''} onClick={() => props.onTheme('auto')}>
            <Icon name="auto" size={16} /> Авто
          </button>
        </div>
        <div style={{ color: 'var(--muted)', fontSize: 12.5, marginTop: 8 }}>
          «Авто» подстраивается под оформление {props.platform.kind === 'telegram' ? 'Telegram' : 'системы'}.
        </div>
      </div>
      ...
      {props.scope === 'guest' && (
        <div className="panel">
          ...
          <div style={{ color: 'var(--muted)', fontSize: 13.5 }}>
            ...
            Войдите с учётной записью ТПУ, чтобы получить помощь по учёбе, доступам, сервисам и оборудованию.
          </div>
        </div>
      )}
      ...
      <div className="panel">
        ...
        <div className="row">
          ...
          <span style={{ textAlign: 'right' }}>определять категорию, задавать уточнения, давать пошаговое решение</span>
        </div>
        <div className="row">
