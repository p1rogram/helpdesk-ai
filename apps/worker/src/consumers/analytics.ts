...
/**
 * AI: Ведёт дневные агрегаты по потоку событий. Про идемпотентность: счётчики увеличиваются на
 * каждое событие; для семантики exactly-once нужно хранить обработанные eventId (здесь не
 * делается).
 */
