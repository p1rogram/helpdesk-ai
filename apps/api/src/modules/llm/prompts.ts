...
export function analyzeSystemPrompt(catalog: LoadedCatalog): string {
  ...
  return [
    ...
    `- Короткие бытовые вопросы о жизни в кампусе («есть столовая?», «где поесть», «где бассейн», «есть ли парковка») — это обычные обращения: категория из списка, которая описывает инфраструктуру кампуса, confidence не ниже 0.7. Краткость вопроса не делает его непонятным и не делает его offTopic.`,
